...
# chosen true label.
_C.TENSORBOARD.HISTOGRAM.TOPK = 1 ##10
...
# -----------------------------------------------------------------------------
# Interaction Dataset options
# -----------------------------------------------------------------------------
_C.Interaction = CfgNode()

_C.Interaction.VISUAL_DATA_DIR = ""

_C.Interaction.ANNOTATIONS_DIR = ""

_C.Interaction.TRAIN_LIST =  ["train.csv"]

_C.Interaction.VAL_LIST =  ["val.csv"]

_C.Interaction.TEST_LIST =  ["test.csv"]

_C.Interaction.TEST_SPLIT = "validation"

_C.Interaction.TRAIN_PLUS_VAL = False
