...
class TrainMeter(object):
    ...
    def log_epoch_stats(self, cur_epoch, cfg):#############
        """
        Log the stats of the current epoch.
        Args:
            cur_epoch (int): the number of current epoch.
        ...
        if not self._cfg.DATA.MULTI_LABEL:
            top1_err = self.num_top1_mis / cfg.DATA.NUM_FRAMES#self.num_samples ###########
            top5_err = self.num_top5_mis / cfg.DATA.NUM_FRAMES#self.num_samples ###########
            avg_loss = self.loss_total / cfg.DATA.NUM_FRAMES#self.num_samples ###########
